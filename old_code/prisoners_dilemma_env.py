...
class PrisonersDilemmaEnv(gym.Env):
    ...
    def __init__(
        ...
        opponent_actors: list[type[Actor]] | None = None,
    ):
        """
        Initialize the environment

        Args:
            - max_steps (int | None): Maximum number of steps in an episode
    ...
    def step(self, action: int):
        ...
        reward = action_decoded.score(opponent_action)
            ...
            self.steps_taken >= self.max_steps if self.max_steps else False
